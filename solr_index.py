...
if __name__ == '__main__':
    ...
    for i, relationship in enumerate(relationships):
        ...
        d = {
            ...
            'model_mt_cad_authentic_b': relationship.model_observation.mt_cad_authentic,
            'model_mt_cad_phrygian_b': relationship.model_observation.mt_cad_phrygian,
            'model_mt_cad_plagal_b': relationship.model_observation.mt_cad_plagal,
            ...
            'derivative_mt_cad_authentic_b': relationship.derivative_observation.mt_cad_authentic,
            'derivative_mt_cad_phrygian_b': relationship.derivative_observation.mt_cad_phrygian,
            'derivative_mt_cad_plagal_b': relationship.derivative_observation.mt_cad_plagal,
