...
def solr_index_single(relationship, solrconn):
    ...
    if relationship.curated:
        ...
        d = {
            ...
            'model_composer_s': relationship.model_observation.piece.composer.name if relationship.model_observation.piece.composer.name else '',
            ...
            'derivative_composer_s': relationship.derivative_observation.piece.composer.name if relationship.derivative_observation.piece.composer.name else '',
