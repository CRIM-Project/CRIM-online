...
def _empty_search(request):
    ...
    data = {
        ...
        'model_mt_cad_authentic': facets['model_mt_cad_authentic_b'],
        'model_mt_cad_phrygian': facets['model_mt_cad_phrygian_b'],
        'model_mt_cad_plagal': facets['model_mt_cad_plagal_b'],
        ...
        'derivative_ema': facets['derivative_ema_s'],
        ...
        'derivative_mt_cad_authentic': facets['derivative_mt_cad_authentic_b'],
        'derivative_mt_cad_phrygian': facets['derivative_mt_cad_phrygian_b'],
        'derivative_mt_cad_plagal': facets['derivative_mt_cad_plagal_b'],
