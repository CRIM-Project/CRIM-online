...
if 'django.contrib.admin' in settings.INSTALLED_APPS:
    ...
    urlpatterns += [
        ...
        re_path(r'^observation/(?P<id>[0-9]+)/$', ObservationDetail.as_view(), name='crimobservation-detail'),
        ...
        re_path(r'^relationship/(?P<id>[0-9]+)/$', RelationshipDetail.as_view(), name='crimrelationship-detail'),
        ...
        re_path(r'^data/observation/(?P<id>[0-9]+)/$', ObservationDetailData.as_view(), name='crimobservation-detail-data'),
        ...
        re_path(r'^data/relationship/(?P<id>[0-9]+)/$', RelationshipDetailData.as_view(), name='crimrelationship-detail-data'),
        ...
        re_path(r'^data/role/(?P<id>[0-9]+)/$', RoleDetailData.as_view(), name='crimrole-detail-data'),
